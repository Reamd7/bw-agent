...
- [x] **Step 2: 创建 bw-core Cargo.toml**
...
- [x] **Step 3: 创建 bw-core/src/lib.rs (存根 —— 模块将逐步添加)**
...
- [x] **Step 4: 创建 bw-core/src/prelude.rs**
...
- [x] **Step 5: 创建存根 bw-ui/Cargo.toml 和 lib.rs**
...
- [x] **Step 6: 创建存根 bw-agent/Cargo.toml 和 main.rs**
...
- [x] **Step 1: 复制 identity.rs 并适配新的加密 API**
...
- [x] **Step 2: 复制 cipherstring.rs 并适配新的加密 API**
...
- [x] **Step 2: 为 EntryData::SshKey 添加往返 serde 测试**
...
- [x] **Step 3: 实现 prelogin, login, sync, exchange_refresh_token (仅限异步)**
...
- [x] **Step 6: 为 Client 构造和 URL 辅助函数添加单元测试**
...
- [x] **Step 0: 预先将所有 agent 模块连接到 main.rs**
...
- [x] **Step 2: 为带有已知测试向量的 decrypt_cipher 添加单元测试**
...
- [x] **Step 1: 从 rbw 移植 ssh_agent.rs**
...
- [x] **Step 2: 为 SshAgentHandler 构造添加单元测试**
...
- [x] **Step 1: 实现带有 CLI 参数和 agent 启动的 main**
